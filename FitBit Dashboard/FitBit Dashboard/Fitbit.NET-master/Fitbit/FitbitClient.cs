...
namespace Fitbit.Api
{
    ...
    public class FitbitClient
    {
        ...
        public ActivitySummary GetSpecificUserDayActivitySummary(String encodedUserId, DateTime activityDate)
        {
            string apiCall = string.Format("/1/user/{0}/activities/date/{1}-{2}-{3}.xml", encodedUserId, activityDate.Year.ToString(), activityDate.Month.ToString(), activityDate.Day.ToString());
